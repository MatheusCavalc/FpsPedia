                ...
                <nav class="flex w-72 h-full">
                    <div class="w-full flex mx-auto px-6 py-8">
                        ...
                        <div
                            ...
                            <template v-if="$page.props.auth.user.editor == 'valorant' || $page.props.auth.user.admin">
                                <Dropdown>
                                    <template #trigger>
                                        <div
                                            class="p-2.5 mt-3 flex items-center rounded-md px-4 duration-300 cursor-pointer hover:bg-blue-600 text-white">
                                            <div class="flex justify-between w-full items-center">
                                                <span class="text-[15px] ml-4 text-gray-200 font-bold">Valorant</span>
                                    ...
                                    <template #content>
                                        <div class="text-left text-sm mt-2 w-4/5 mx-auto text-gray-200 font-bold"
                                            ...
                                            <Link :href="route('dashboard.valorant.tournaments.index')">
                                            <h1 class="cursor-pointer p-2 hover:bg-blue-600 rounded-md mt-1">Tournaments</h1>
                                            </Link>
                                        </div>
                                    </template>
                                </Dropdown>
                            ...
                            <template v-if="$page.props.auth.user.editor == 'csgo' || $page.props.auth.user.admin">
                                <Dropdown>
                                    <template #trigger>
                                        <div
                                            class="p-2.5 mt-3 flex items-center rounded-md px-4 duration-300 cursor-pointer hover:bg-blue-600 text-white">
                                            <div class="flex justify-between w-full items-center">
                                                <span class="text-[15px] ml-4 text-gray-200 font-bold">CSGO</span>
                                                <span class="text-sm rotate-180" id="arrow">
                                                </span>
                                            </div>
                                        </div>
                                    ...
                                    <template #content>
                                        <div class="text-left text-sm mt-2 w-4/5 mx-auto text-gray-200 font-bold"
                                            ...
                                            <Link :href="route('dashboard.csgo.tournaments.index')">
                                            <h1 class="cursor-pointer p-2 hover:bg-blue-600 rounded-md mt-1">Tournaments
                                            </h1>
                                            </Link>
                                        </div>
                                    </template>
                            ...
                            <template v-if="$page.props.auth.user.editor == 'rainbowsix' || $page.props.auth.user.admin">
                                <Dropdown>
                                    <template #trigger>
                                        <div
                                            class="p-2.5 mt-3 flex items-center rounded-md px-4 duration-300 cursor-pointer hover:bg-blue-600 text-white">
                                            <div class="flex justify-between w-full items-center">
                                                <span class="text-[15px] ml-4 text-gray-200 font-bold">Rainbow Six</span>
                                                <span class="text-sm rotate-180" id="arrow">
                                                </span>
                                            </div>
                                        </div>
                                    ...
                                    <template #content>
                                        <div class="text-left text-sm mt-2 w-4/5 mx-auto text-gray-200 font-bold"
                                            id="submenu">
                                            <Link :href="route('dashboard.rainbowsix.teams.index')">
                                            <h1 class="cursor-pointer p-2 hover:bg-blue-600 rounded-md mt-1">Teams</h1>
                                            </Link>
                                            <Link :href="route('dashboard.rainbowsix.players.index')">
                                            <h1 class="cursor-pointer p-2 hover:bg-blue-600 rounded-md mt-1">Players</h1>
                                            </Link>
                                            <Link :href="route('dashboard.rainbowsix.tournaments.index')">
                                            <h1 class="cursor-pointer p-2 hover:bg-blue-600 rounded-md mt-1">Tournaments</h1>
                                            </Link>
                                        </div>
                                    </template>
                                ...
                                <Dropdown>
                                    <template #trigger>
                                        <div
                                            class="p-2.5 mt-3 flex items-center rounded-md px-4 duration-300 cursor-pointer hover:bg-blue-600 text-white">
                                            <div class="flex justify-between w-full items-center">
                                                <span class="text-[15px] ml-4 text-gray-200 font-bold">All
                                                    Contributes</span>
                                                <span class="text-sm rotate-180" id="arrow">
                                                </span>
                                            </div>
                                    ...
                                    <template #content>
                                        <div class="text-left text-sm mt-2 w-4/5 mx-auto text-gray-200 font-bold"
                                            ...
                                            <Link :href="route('dashboard.contribute.rainbowsix')">
                                            <h1 class="cursor-pointer p-2 hover:bg-blue-600 rounded-md mt-1">Rainbow Six
                                            </h1>
                                            </Link>
                                        </div>
                                    </template>
